...
const uploadProductThumbstorage = multer.diskStorage({
...
const uploadProductThumb = multer({ storage: uploadProductThumbstorage });
...
app.post("/thumbnailUpload", uploadProductThumb.single("productThumbnail"), (req, res) => {
  try {
